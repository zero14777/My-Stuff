 ...
 * Cruz ID: 1301397
 *
 * A dictionary abstract data type module. This dictionary implementation
 * uses hashing and chaining to manage a hash-table of keys, each of which
 * has its' own list of locations. This dictionary makes use of a generic
 * void * pointer linked list to handle hashing collision and a key having 
...
static KeyNode NewKeyNode (char* key, int location)
{
...
static void AddLocationToNode (KeyNode node, int location)
{
	assert (node != NULL);
