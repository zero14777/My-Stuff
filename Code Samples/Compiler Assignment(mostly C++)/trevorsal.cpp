/*
	The file name is a joke about a friend of ours.
	
	This code traverses the tree created and checks for proper
	syntax. It also ensures that variables and functions used
	are always in scope with the assistance of a symbol table.
*/
