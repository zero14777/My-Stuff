/*
This code is used by trevorsal.cpp to keep track of when variables
and functions are in scope. This is by maintaining theSymbolStack,
which pushes and pops symbol_tables as levels of scope are entered
and exited. The symbol tables are just hash tables containing symbol
structs that contain the actual details on a symbol.
*/
